...
public class FindByTittleCommand implements ActionCommand {
    @Override
    public Map<String, Object> execute(Map<String, Object> params) {

        Map<String, Object> response = new HashMap<>();
        String tittle = (String) params.get(RequestParam.BOOK_TITTLE);
        BookServiceImpl bookService = new BookServiceImpl();
        List<Book> findResult = bookService.findByTitle(tittle);
