...
public class AddBookCommand implements ActionCommand {
    ...
    public Map<String, Object> execute(Map<String, Object> params) {
        ...
        Book book = new Book((String) params.get(RequestParam.BOOK_TITTLE),Arrays.asList((String[]) params.get(RequestParam.AUTHOR))
                ,(int)params.get(RequestParam.YEAR_OF_PUBLICATION),
                (int) params.get(RequestParam.COUNT_OF_PAGE));
        try{
